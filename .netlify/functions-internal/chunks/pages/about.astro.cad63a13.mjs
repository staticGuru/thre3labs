...
import { $ as $$Container, a as $$Layout } from './404.astro.6b77d0d5.mjs';
import { g as getAboutContents } from './_slug_.astro.d6b62979.mjs';
...
async function getImage(transform) {
  ...
  if (!loader) {
    const { default: mod } = await import('./endpoint.js.b5a07199.mjs').then(n => n.s).catch(() => {
      throw new Error(
...
export { $$Sectionhead as $, BaseSSRService as B, $$Picture as a, isRemoteImage as b, about as c, isOutputFormatSupportsAlpha as i };
