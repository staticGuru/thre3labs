...
import { i as isValidEmail, e as isRegistered } from './_slug_.astro.f152fb60.mjs';
import { L as Logo } from './404.astro.cc71b858.mjs';
import 'cookie';
import 'kleur/colors';
      ...
      <div class="mt-5">
        <form method="POST">
          <div>
            ...
            <input class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="" placeholder="mike@gmail.com" name="email">
            ${errors.email && renderTemplate`<p>${errors.email}</p>`}
          </div>
          <div class="mt-8">
            <div class="text-sm font-bold text-gray-700 tracking-wide">
              Username
            </div>
            <input class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="" placeholder="Nikilmethew" name="username">
            ${errors.username && renderTemplate`<p>${errors.username}</p>`}
          </div>
          <div class="mt-8">
            ...
            ${errors.password && renderTemplate`<p>${errors.password}</p>`}
          </div>
          <div class="mt-8">
            <div class="flex justify-between items-center">
              <div class="text-sm font-bold text-gray-700 tracking-wide">
            ...
            <input class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="" placeholder="Enter confirm password" name="confirm-password">
            ${errors.password && renderTemplate`<p>${errors.confirmPassword}</p>`}
          </div>
          <div class="mt-10">
