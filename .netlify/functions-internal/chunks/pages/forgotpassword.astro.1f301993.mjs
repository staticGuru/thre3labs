...
const $$Forgotpassword = createComponent(async ($$result, $$props, $$slots) => {
  ...
  <div class="h-full flex justify-center items-center text-gray-900 bg-transparent">
    <div class="w-full px-8 max-w-lg space-y-6 bg-white rounded-md py-16">
      ...
      <form action="/resetpassword" class="space-y-6 w-ful">
        <input class="w-full px-4 py-2 border rounded-md focus:outline-none focus:ring focus:ring-primary-100" type="email" name="email" placeholder="Email address" required="">
        <div>
          <button type="submit" class="w-full px-4 py-2 font-medium text-center text-white bg-indigo-600 transition-colors duration-200 rounded-md bg-primary hover:bg-primary-dark focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-1">
            Send
          </button>
        </div>
      </form>
...
}, "E:/Upwork projects/Nikesh_web3/thre3labs-demo/src/pages/forgotpassword.astro", void 0);

const $$file = "E:/Upwork projects/Nikesh_web3/thre3labs-demo/src/pages/forgotpassword.astro";
