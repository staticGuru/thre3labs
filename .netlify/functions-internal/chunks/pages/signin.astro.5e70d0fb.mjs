...
import { A as AuthService } from './_slug_.astro.f152fb60.mjs';
import 'cookie';
import 'kleur/colors';
      ...
      <div class="mt-12">
        ...
        <form method="POST">
          <div>
            ...
            <input class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="" placeholder="mike">
          </div>
          <div class="mt-8">
