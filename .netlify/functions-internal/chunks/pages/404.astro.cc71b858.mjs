  ...
  ${maybeRenderHead()}<header class="flex flex-col lg:flex-row justify-between items-center my-5">
    ...
    <div>
      <div class="hidden lg:flex items-center gap-4">
        ${renderComponent($$result2, "Link", $$Link, { "href": "/signin", "size": "md" }, { "default": ($$result3) => renderTemplate`Log in` })}
        ${renderComponent($$result2, "Link", $$Link, { "href": "/signup", "size": "md" }, { "default": ($$result3) => renderTemplate`Sign up` })}
      </div>
    </div>
  </header>
` })}`;
