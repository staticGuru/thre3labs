...
import { L as Logo } from './404.astro.6b77d0d5.mjs';
import { A as AuthService } from './_slug_.astro.d6b62979.mjs';
import 'cookie';
import 'kleur/colors';
...
const $$Signin = createComponent(async ($$result, $$props, $$slots) => {
  ...
  console.log("signInapi data res", Astro2.cookies.set("cookie_name", "datascience"));
  console.log("signInapi data res", Astro2.cookies.get("cookie_name"));
  return renderTemplate`

${maybeRenderHead()}<div class="lg:flex">
  <div class="lg:w-1/2 xl:max-w-screen-sm">
    ...
    <div class="mt-10 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 xl:max-w-2xl">
      ...
      <div class="mt-12">
        ${errors.error && renderTemplate`<p>${errors.error}</p>`}
        <form method="POST">
          <div>
            <div class="text-sm font-bold text-gray-700 tracking-wide">
              Username
            </div>
            <input class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="" name="username" placeholder="mike">
          </div>
          <div class="mt-8">
            ...
            <input class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="" name="password" placeholder="Enter your password">
          ...
          <div class="mt-10">
            <button data-confetti-button type="submit" class="bg-indigo-500 text-gray-100 p-4 w-full rounded-full tracking-wide font-semibold font-display focus:outline-none focus:shadow-outline hover:bg-indigo-600 shadow-lg">
              Log In
            </button>
          </div>
        </form>
